...
def getNewBoard():
    ...
    for x in range(60):  # The main list is a list of 60 lists
        board.append([])
        for y in range(15):  # Eah list in the mian list has 15 single-character strings
...
def makeMove(board, chests, x, y):
    ...
    if smallestDistance == 0:
        ...
        chests.remove([x, y])
        return 'You have a sunken treasure chest!'
    else:
...
while True:
    ...
    while sonarDevices > 0:
        ...
        print('You have %s sonar devices(s) left. %s treasure chest(s) remaining.' % (sonarDevices, len(theChests)))
    ...
    if sonarDevices == 0:
        print('We\'ve run out of sonar devices! Now we have turn the ship around and head')
